            ...
            <div className="p-4 w-full max-w-md h-full md:h-auto">
                <div className="bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#" onSubmit={handleOnSubmit}>
                        ...
                        <div>
                            <label for="priority" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Priority</label>
                            <div className="flex justify-around">
                                <div className="flex p-2">
                                    <input className="mt-2" type="radio" id="high" name="priority" value="high" required/>
                                    <label className="px-2" for="high">High</label>
                                    <div className="w-4 h-4 rounded-full bg-red-400 mt-1"></div>                                    
                                </div>
                                <div className="flex p-2">
                                    <input className="mt-2" type="radio" id="medium" name="priority" value="medium" checked />
                                    <label className="px-2" for="medium">Medium</label>
                                    <div className="w-4 h-4 rounded-full bg-yellow-300 mt-1"></div>                                    
                                </div>
                                <div className="flex p-2">
                                    <input className="mt-2" type="radio" id="low" name="priority" value="low" />
                                    <label className="px-2" for="low">Low</label>
